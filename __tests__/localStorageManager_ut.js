...
const LocalStorageManager = require('../requires/user/localStorageManager.js/index.js');
...
describe('Test saveEvolveByLevelList', () => {
    ...
    test('Should load existing evolve by level exists when it exists', () => {
        ...
        const parsedFamilies = {
            ...
            'Charmeleon': charmanderFamily,
            'Charizard': charmanderFamily,
            'Charizard [Mega Forme X]': charmanderFamily,
            'Charizard [Mega Forme Y]': charmanderFamily,
        };
        const dexIDs = {
            'Charmander': '004',
            'Charmeleon': '005',

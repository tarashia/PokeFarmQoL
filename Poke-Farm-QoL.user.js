...
class LocalStorageManager {
    ...
    static getAllQoLSettings(includeDex=false) {
        ...
        for (let i = 0, len = localStorage.length; i < len; ++i) {
            ...
            console.log('getting settings: '+key);

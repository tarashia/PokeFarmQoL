...
class Resources {
    ...
    static SEARCH_CSS = `.searchChecks>div{box-sizing:border-box;display:inline-block;padding:3px;width:33%}.searchChecks>div label{white-space:nowrap}.mq2 .searchChecks>div{width:50%}`;
    ...
    static SHELTER_SEARCH_HTML = `<p>Enter search criteria below to highlight specific Pokemon. Use the letter 'n' key to select and cycle through the Pokemon matched by the script.</p><div class="searchChecks"><div><label><input type="checkbox" class="qolsetting" data-key="findNewEgg">New Egg</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findNewPokemon">New Pokemon</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findShiny">Shiny</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findAlbino">Albino</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findMelanistic">Melanistic</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findPrehistoric">Prehistoric</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findDelta">Delta</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findMega">Mega</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findStarter">Starter</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findCustomSprite">Custom Sprite</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findTotem">Totem</label></div><div><label><input type="checkbox" class="qolsetting" data-key="findLegendary">Legendary</label></div></div><h4 style="margin-block-end:0.5em;">Quick search</h4><button type="button" id="qolQuickTextBtn">Add text</button> <button type="button" id="qolQuickTypeBtn">Add type</button><div id="qolQuickShelterSearches"></div><h4 style="margin-block-end:0.5em;">Advanced search</h4><button type="button" id="qolNewAdvancedSearchBtn">New search</button><div id="qolAdvancedShelterSearches"></div></div>`;

...
class Resources {
    ...
    static HUB_CSS = `.qolHubModal textarea{box-sizing:border-box;width:100%}#qolStorageOutput{border:1px solid;max-height:100px;overflow-y:auto;padding:3px;user-select:all}#qolConsoleContent,#qolStorageOutput{word-break:break-all}`;
    static MODAL_CSS = ``;
    ...
    static QOL_HUB_ICON_HTML = `<li data-name="QoL"><a title="QoL Settings"><img src="https://pokefarm.com/upload/:b7q/QoL/icon.png" alt="QoL Settings">QoL </a><!-- The QoL hub doesn't exist until opened; store custom errors here initially instead --><ul style="display: none;" id="qolConsoleHolder"></ul></li>`;
